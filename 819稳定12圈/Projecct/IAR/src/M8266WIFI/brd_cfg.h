...
//#define MCU_IS_STM32L1XX
//#define MCU_IS_STM32L4XX
//#define MCU_IS_STM32H7XX
...
//#define MCU_IS_NXP_MK60

#define MCU_IS_NXP_iMXRT10xx   // NXP's iMX RT10xx
...
#elif defined(MCU_IS_STM32F2XX) // STM's STM32F2XX, 
////using *GPIOD0* as nRESET
...
#elif defined(MCU_IS_NXP_iMXRT10xx)   // NXP's iMX RT10xx using
//// embedfire EVK1052: using *GPIO_SD_B0_04 GPIO3_IO16* as nRESET
//#define  M8266WIFI_nRESET_PORT_MUX									IOMUXC_GPIO_SD_B0_04_GPIO3_IO16
//#define  M8266WIFI_nRESET_GPIO											GPIO3
//#define  M8266WIFI_nRESET_GPIO_PIN									16
// NXP-BJ-OPENMV: using *IOMUXC_GPIO_AD_B0_13 GPIO1_IO13* as nRESET
#define  M8266WIFI_nRESET_PORT_MUX									IOMUXC_GPIO_SD_B1_02_GPIO3_IO02
#define  M8266WIFI_nRESET_GPIO											GPIO3
#define  M8266WIFI_nRESET_GPIO_PIN									2
...
#elif defined(MCU_IS_NXP_iMXRT10xx)   // NXP's iMX RT10xx 
//// embedfire EVK1052: using *GPIO_SD_B0_05 GPIO3_IO17* as nCS 
//#define  M8266WIFI_SPI_nCS_PORT_MUX									IOMUXC_GPIO_SD_B0_05_GPIO3_IO17
//#define  M8266WIFI_SPI_nCS_GPIO											GPIO3
//#define  M8266WIFI_SPI_nCS_GPIO_PIN									17
// NXP-BJ-OPENMV: using *IOMUXC_GPIO_AD_B1_08 GPIO1_IO24* as nCS
//SPI1 CS模数
// #define  M8266WIFI_SPI_nCS_PORT_MUX									IOMUXC_GPIO_SD_B0_01_LPSPI1_PCS0
// #define  M8266WIFI_SPI_nCS_GPIO											GPIO3
// #define  M8266WIFI_SPI_nCS_GPIO_PIN									13
//CS 普通IO
#define  M8266WIFI_SPI_nCS_PORT_MUX									IOMUXC_GPIO_SD_B0_01_GPIO3_IO13
#define  M8266WIFI_SPI_nCS_GPIO											GPIO3
#define  M8266WIFI_SPI_nCS_GPIO_PIN									13
...
#if defined(MCU_IS_STM32F1XX) || defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) \
 || defined(MCU_IS_STM32F4XX) || defined(MCU_IS_STM32F7XX) \
 || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) \
 || defined(MCU_IS_STM32H7XX)
#define MCU_IS_STM32
#endif
...
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
  ...
  GPIO_InitStructure.GPIO_PuPd 	= GPIO_PuPd_UP;								\
	GPIO_Init(gpio, &GPIO_InitStructure)	
#elif defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) // STM's STM32F7XX, STM32L1XX, STM32L4XX, using HAL 
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
...
#elif defined(MCU_IS_STM32H7XX) // STM's STM32H7XX, using HAL 
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
	GPIO_InitStructure.Pin 				= pin;												\
	GPIO_InitStructure.Mode  			= GPIO_MODE_OUTPUT_PP;				\
...
#elif   defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) // STM's STM32F3XX, STM32F7XX, STM32L1XX, STM32L4XX
...
#elif (M8266WIFI_SPI_INTERFACE_NO == 2)
  #define  M8266WIFI_INTERFACE_SPI								LPSPI2
#elif (M8266WIFI_SPI_INTERFACE_NO == 3)
  #define  M8266WIFI_INTERFACE_SPI								LPSPI3
#elif (M8266WIFI_SPI_INTERFACE_NO == 4)
  #define  M8266WIFI_INTERFACE_SPI								LPSPI4
#else
#error Wrong M8266WIFI_SPI_INTERFACE_NO defined near line 137 for MCU_IS_NXP_iMXRT10xx in brd_cfg.h
#endif

...
void MPU_Memory_Protection(void);	//配置RT1062的MPU
void Sys_Soft_Reset(void);          //软件复位RT1062
void RT10xx_Clock_Init(void); 	    //配置系统时钟
void RT10xx_NVIC_SetPriorityGrouping(u8 grpx);
void RT10xx_NVIC_SetPriority(IRQn_Type IRQn,u32 prep,u32 subp);

...
from model import create_model160x64    #加载模型
# from darknet53 import darknet
from new_model import efficientnet_lite
...
# xs = np.concatenate([x_train, x_test], axis=0) #concatenate：多个数组拼接
...
if __name__ == "__main__":
    ...
    model.fit(x_train, y_train, epochs=10, batch_size=16,
              validation_data=(x_test, y_test), callbacks=callbacks)#batch_size比较大
